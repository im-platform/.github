# Contributing
The following is a set of general guidelines for contributing to `im-platform` projects.
...
## Code of Conduct
This project is governed by the `im-platform` Organization's [Code of Conduct](./CODE_OF_CONDUCT.md).  By participating you are expected to uphold this code.    
